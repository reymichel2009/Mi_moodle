...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        tl_admin_user = os.environ.get('reymichel2009')
        ...
        if '/start' in msgText:
            start_msg = 'Bienvenido al bot 7.1🤖. Disfrute este bot como un dios👨‍💻☁️\n'
            ...
            #    bot_token = '5358292072:AAGcN8I25endYbQcFsY73AX0ijxVeNxoSrc'
